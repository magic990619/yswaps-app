...
export class CurveYfiEth implements Solver {
  ...
  private async loadContracts(): Promise<void> {
    ...
    this._crvSwap = await ethers.getContractAt<CurveFi>(
      CurveFi__factory.abi,
  ...
  async solve({
    ...
    const addLiquidityTx = await this._crvSwap.populateTransaction['add_liquidity(uint256[2],uint256,bool,address)'](
      [wethBalance, 0],
