...
export interface ZRXSwapperInterface extends utils.Interface {
  contractName: 'ZRXSwapper';
  functions: {
...
export interface ZRXSwapper extends BaseContract {
  contractName: 'ZRXSwapper';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZRXSwapperInterface;
