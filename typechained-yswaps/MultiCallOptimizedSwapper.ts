...
export interface MultiCallOptimizedSwapperInterface extends utils.Interface {
  contractName: 'MultiCallOptimizedSwapper';
  functions: {
...
export interface MultiCallOptimizedSwapper extends BaseContract {
  contractName: 'MultiCallOptimizedSwapper';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultiCallOptimizedSwapperInterface;
