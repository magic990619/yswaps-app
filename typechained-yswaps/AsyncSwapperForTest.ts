...
export interface AsyncSwapperForTestInterface extends utils.Interface {
  contractName: 'AsyncSwapperForTest';
  functions: {
    ...
    'setReceivedAmount(uint256)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'setReceivedAmount', values: [BigNumberish]): string;
  ...
  decodeFunctionResult(functionFragment: 'setReceivedAmount', data: BytesLike): Result;
  ...
  events: {
    ...
    'MyInternalExecuteSwap(address,address,address,uint256,bytes)': EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: 'MyInternalExecuteSwap'): EventFragment;
...
export type MyInternalExecuteSwapEvent = TypedEvent<
...
export type MyInternalExecuteSwapEventFilter = TypedEventFilter<MyInternalExecuteSwapEvent>;
...
export interface AsyncSwapperForTest extends BaseContract {
  contractName: 'AsyncSwapperForTest';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AsyncSwapperForTestInterface;
  ...
  functions: {
    ...
    setReceivedAmount(__receivedAmount: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    setReceivedAmount(__receivedAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    'MyInternalExecuteSwap(address,address,address,uint256,bytes)'(
      _receiver?: null,
      _tokenIn?: null,
      _tokenOut?: null,
      _amountIn?: null,
      _data?: null
    ): MyInternalExecuteSwapEventFilter;
    MyInternalExecuteSwap(_receiver?: null, _tokenIn?: null, _tokenOut?: null, _amountIn?: null, _data?: null): MyInternalExecuteSwapEventFilter;
  ...
  estimateGas: {
    ...
    setReceivedAmount(__receivedAmount: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
