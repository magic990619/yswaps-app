...
export interface MultipleAsyncSwapperInterface extends utils.Interface {
  contractName: 'MultipleAsyncSwapper';
  functions: {
...
export interface MultipleAsyncSwapper extends BaseContract {
  contractName: 'MultipleAsyncSwapper';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultipleAsyncSwapperInterface;
