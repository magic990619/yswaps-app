...
export interface TradeFactoryPositionsHandlerForTestInterface extends utils.Interface {
  contractName: 'TradeFactoryPositionsHandlerForTest';
  functions: {
...
export interface TradeFactoryPositionsHandlerForTest extends BaseContract {
  contractName: 'TradeFactoryPositionsHandlerForTest';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TradeFactoryPositionsHandlerForTestInterface;
