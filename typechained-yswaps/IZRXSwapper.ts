...
export interface IZRXSwapperInterface extends utils.Interface {
  contractName: 'IZRXSwapper';
  functions: {
    'SWAPPER_TYPE()': FunctionFragment;
    'ZRX()': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'ZRX', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: 'ZRX', data: BytesLike): Result;
...
export interface IZRXSwapper extends BaseContract {
  contractName: 'IZRXSwapper';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IZRXSwapperInterface;
  ...
  functions: {
    ...
    ZRX(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    ZRX(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    ZRX(overrides?: CallOverrides): Promise<PopulatedTransaction>;
