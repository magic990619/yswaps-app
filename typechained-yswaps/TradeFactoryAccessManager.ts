...
export interface TradeFactoryAccessManagerInterface extends utils.Interface {
  contractName: 'TradeFactoryAccessManager';
  functions: {
...
export interface TradeFactoryAccessManager extends BaseContract {
  contractName: 'TradeFactoryAccessManager';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TradeFactoryAccessManagerInterface;
