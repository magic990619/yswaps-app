...
export interface ISolidlySwapperInterface extends utils.Interface {
  contractName: 'ISolidlySwapper';
  functions: {
...
export interface ISolidlySwapper extends BaseContract {
  contractName: 'ISolidlySwapper';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISolidlySwapperInterface;
