...
export interface BancorSwapperInterface extends utils.Interface {
  contractName: 'BancorSwapper';
  functions: {
...
export interface BancorSwapper extends BaseContract {
  contractName: 'BancorSwapper';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BancorSwapperInterface;
  ...
  estimateGas: {
    ...
    bancorNetworkName(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    bancorNetworkName(overrides?: CallOverrides): Promise<PopulatedTransaction>;
