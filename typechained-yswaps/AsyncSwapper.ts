...
export interface AsyncSwapperInterface extends utils.Interface {
  contractName: 'AsyncSwapper';
  functions: {
...
export interface AsyncSwapper extends BaseContract {
  contractName: 'AsyncSwapper';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AsyncSwapperInterface;
