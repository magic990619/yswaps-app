...
export interface SyncSwapperForTestInterface extends utils.Interface {
  contractName: 'SyncSwapperForTest';
  functions: {
...
export interface SyncSwapperForTest extends BaseContract {
  contractName: 'SyncSwapperForTest';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SyncSwapperForTestInterface;
