...
export interface SwapperEnabledInterface extends utils.Interface {
  contractName: 'SwapperEnabled';
  functions: {
...
export interface SwapperEnabled extends BaseContract {
  contractName: 'SwapperEnabled';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SwapperEnabledInterface;
