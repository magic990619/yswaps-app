...
export interface SyncSwapperInterface extends utils.Interface {
  contractName: 'SyncSwapper';
  functions: {
...
export interface SyncSwapper extends BaseContract {
  contractName: 'SyncSwapper';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SyncSwapperInterface;
