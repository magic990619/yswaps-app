...
export interface SwapperForTestInterface extends utils.Interface {
  contractName: 'SwapperForTest';
  functions: {
    ...
    'modifierOnlyTradeFactory()': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'modifierOnlyTradeFactory', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: 'modifierOnlyTradeFactory', data: BytesLike): Result;
...
export interface SwapperForTest extends BaseContract {
  contractName: 'SwapperForTest';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SwapperForTestInterface;
  ...
  functions: {
    ...
    modifierOnlyTradeFactory(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    modifierOnlyTradeFactory(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    modifierOnlyTradeFactory(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    modifierOnlyTradeFactory(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
