...
export interface IUniswapV2AnchorSwapperInterface extends utils.Interface {
  contractName: 'IUniswapV2AnchorSwapper';
  functions: {
    'FACTORY()': FunctionFragment;
    'ROUTER()': FunctionFragment;
    'SLIPPAGE_PRECISION()': FunctionFragment;
    'SWAPPER_TYPE()': FunctionFragment;
    'WANCHOR()': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'WANCHOR', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: 'WANCHOR', data: BytesLike): Result;
...
export interface IUniswapV2AnchorSwapper extends BaseContract {
  contractName: 'IUniswapV2AnchorSwapper';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IUniswapV2AnchorSwapperInterface;
  ...
  functions: {
    ...
    WANCHOR(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    WANCHOR(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    WANCHOR(overrides?: CallOverrides): Promise<PopulatedTransaction>;
