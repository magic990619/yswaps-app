...
export interface TradeFactoryExecutorInterface extends utils.Interface {
  contractName: 'TradeFactoryExecutor';
  functions: {
...
export interface TradeFactoryExecutor extends BaseContract {
  contractName: 'TradeFactoryExecutor';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TradeFactoryExecutorInterface;
