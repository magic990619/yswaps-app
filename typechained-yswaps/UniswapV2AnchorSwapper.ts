...
export interface UniswapV2AnchorSwapperInterface extends utils.Interface {
  contractName: 'UniswapV2AnchorSwapper';
  functions: {
...
export interface UniswapV2AnchorSwapper extends BaseContract {
  contractName: 'UniswapV2AnchorSwapper';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniswapV2AnchorSwapperInterface;
