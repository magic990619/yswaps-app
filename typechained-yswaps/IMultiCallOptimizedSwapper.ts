...
export interface IMultiCallOptimizedSwapperInterface extends utils.Interface {
  contractName: 'IMultiCallOptimizedSwapper';
  functions: {
...
export interface IMultiCallOptimizedSwapper extends BaseContract {
  contractName: 'IMultiCallOptimizedSwapper';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMultiCallOptimizedSwapperInterface;
