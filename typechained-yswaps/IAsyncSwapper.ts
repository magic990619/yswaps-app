...
export interface IAsyncSwapperInterface extends utils.Interface {
  contractName: 'IAsyncSwapper';
  functions: {
...
export interface IAsyncSwapper extends BaseContract {
  contractName: 'IAsyncSwapper';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAsyncSwapperInterface;
