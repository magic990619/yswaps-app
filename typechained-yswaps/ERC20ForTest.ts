...
export interface ERC20ForTestInterface extends utils.Interface {
  contractName: 'ERC20ForTest';
  functions: {
...
export interface ERC20ForTest extends BaseContract {
  contractName: 'ERC20ForTest';
  ...
  functions: {
    ...
    burn(_account: string, _amount: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
    ...
    mint(_account: string, _amount: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    approveInternal(_owner: string, _spender: string, _value: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    transferInternal(_from: string, _to: string, _value: BigNumberish, overrides?: CallOverrides): Promise<void>;
  };
  ...
  estimateGas: {
    ...
    burn(_account: string, _amount: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    mint(_account: string, _amount: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    burn(_account: string, _amount: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
    ...
    mint(_account: string, _amount: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
