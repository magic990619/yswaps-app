...
export interface IOneInchAggregatorSwapperInterface extends utils.Interface {
  contractName: 'IOneInchAggregatorSwapper';
  functions: {
...
export interface IOneInchAggregatorSwapper extends BaseContract {
  contractName: 'IOneInchAggregatorSwapper';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOneInchAggregatorSwapperInterface;
